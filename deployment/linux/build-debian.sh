#!/bin/sh
echo Création de la préparation pour la version 4.9.15
...
sed -i -e "s/@version@/4.9.15/g" /home/favdb/ext/SB4/code/distrib/debian-package/DEBIAN/control
sed -i -e "s/@version@/4.9.15/g" /home/favdb/ext/SB4/code/distrib/debian-package/usr/share/applications/ostorybook.desktop
sed -i -e "s/@version@/4.9.15/g" /home/favdb/ext/SB4/code/distrib/debian-package/usr/share/doc/ostorybook/changelog
...
dpkg-deb --build /home/favdb/ext/SB4/code/distrib/debian-package /home/favdb/ext/SB4/code/distrib/oStorybook-4.9.15.deb
echo Nettoyage...
