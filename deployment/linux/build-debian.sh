#!/bin/sh
echo Création de la préparation pour la version 4.9.16
...
sed -i -e "s/@version@/4.9.16/g" /home/favdb/ext/SB4/code/distrib/debian-package/DEBIAN/control
sed -i -e "s/@version@/4.9.16/g" /home/favdb/ext/SB4/code/distrib/debian-package/usr/share/applications/ostorybook.desktop
sed -i -e "s/@version@/4.9.16/g" /home/favdb/ext/SB4/code/distrib/debian-package/usr/share/doc/ostorybook/changelog
...
dpkg-deb --build /home/favdb/ext/SB4/code/distrib/debian-package /home/favdb/ext/SB4/code/distrib/oStorybook-4.9.16.deb
echo Nettoyage...
rm -r -f /home/favdb/ext/SB4/code/distrib/debian-package
echo Construction du paquet RPM
alien -r /home/favdb/ext/SB4/code/distrib/oStorybook-4.9.16.deb