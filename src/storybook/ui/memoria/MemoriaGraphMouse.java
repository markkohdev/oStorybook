...
public class MemoriaGraphMouse extends AbstractPopupGraphMousePlugin
	...
	public MemoriaGraphMouse(MemoriaPanel paramMemoriaPanel) {
		this.parent = paramMemoriaPanel;
	}
	...
	public MemoriaGraphMouse(int paramInt) {
		super(paramInt);
	}
	...
	protected void handlePopup(MouseEvent paramMouseEvent) {
		...
		if (localGraphElementAccessor != null) {
			...
			if (localAbstractEntity != null) {
				JPopupMenu localJPopupMenu = EntityUtil.createPopupMenu(this.parent.getMainFrame(), localAbstractEntity);
				localJPopupMenu.show(localVisualizationViewer, paramMouseEvent.getX(), paramMouseEvent.getY());
			}
		}
	}
