...
import storybook.view.options.ManageOptionsDialog;
...
public class ManagePanel extends AbstractScrollPanel {
	...
	public void modelPropertyChange(PropertyChangeEvent evt) {
		...
		if (DocumentController.ChapterProps.DELETE.check(propName)
				|| DocumentController.ChapterProps.DELETE_MULTI.check(propName)
				|| DocumentController.ChapterProps.NEW.check(propName)) {
			refresh();
			return;
		}
	...
	public void refresh() {
		...
		JScrollPane scrollerUnassigend = new JScrollPane(new ChapterPanel(
				mainFrame));
	...
	private static void dispatchToChapterPanels(Container cont,
