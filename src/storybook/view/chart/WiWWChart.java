...
import storybook.view.chart.legend.PersonsLegendPanel;
...
public class WiWWChart extends AbstractPersonsChart
	...
	private JTable createTable() {
		...
		((JTable) localObject2).setAutoResizeMode(0);
		((JTable) localObject2).getTableHeader().setReorderingAllowed(false);
		return (JTable) localObject2;
	}
