...
public abstract class AbstractTagLink extends AbstractEntity {
	...
	private static final long serialVersionUID = -4479101338341916177L;
	...
	public AbstractTagLink(Integer type, Scene startScene, Scene endScene,
	...
	public boolean hasOnlyScene() {
		return startScene != null && endScene == null && person == null
				&& location == null;
	}
