	...
	public List<Date> findDistinctDates(Part part) {
		...
		for (Scene scene : scenes) {
			if (part != null) {
				...
				if (chapter != null) {
					if (chapter.getPart().getId() != part.getId()) {
						continue;
					}
				}
			}
