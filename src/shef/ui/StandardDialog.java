 ...
 * <P> By default, the dialog is modal, and has a JPanel with a BorderLayout for its content pane.
 *
 * @author David Fraser
...
public class StandardDialog extends JDialog {
	...
	private static final HtmlEditorI18n i18n = HtmlEditorI18n.getInstance("shef.ui");
	// Constants
	...
	/**
	 * This method returns
	 * <code>true</code> if the User cancelled the dialog otherwise
	 * <code>false</code>. The dialog is cancelled if the "Cancel" button is pressed or the "Close" window button is
	 * pressed, or the "Escape" key is pressed. In other words, if the User has caused the dialog to close by any method
	 * other than by pressing the "Ok" button, this method will return
	 * <code>true</code>.
	 */
