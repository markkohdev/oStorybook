...
public class HtmlEditorI18n
{
    ...
    private HtmlEditorI18n(String _package)
    {
    ...
    public static HtmlEditorI18n getInstance(String _package)
    {
        HtmlEditorI18n i18n = (HtmlEditorI18n)I18NS.get(_package);
        if(i18n == null)
        {
            i18n = new HtmlEditorI18n(_package);
    ...
    public static void setLocale(Locale loc)
    {
        ...
        {
            HtmlEditorI18n i18n = (HtmlEditorI18n)it.next();
    ...
    public static void setBundleForPackage(String _package, String bundle)
    {
        ...
        if(i18n != null) {
			i18n.bundle = null;
		} //reset to null so the bundle is recreated for the new name
    }
